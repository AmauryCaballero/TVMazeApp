...
import 'package:tv_maze_app/core/configuration/di/injectable_config.dart'
    as _i20;
import 'package:tv_maze_app/core/network/network_info.dart' as _i11;
import 'package:tv_maze_app/core/theme/app_theme.dart' as _i3;
import 'package:tv_maze_app/data/api/tvmaze_api_service.dart' as _i10;
...
import 'package:tv_maze_app/data/datasources/series_remote_data_source.dart'
    as _i14;
import 'package:tv_maze_app/domain/repositories/series_repository.dart' as _i13;
import 'package:tv_maze_app/domain/usecases/get_all_series.dart' as _i15;
import 'package:tv_maze_app/domain/usecases/get_episode_details.dart' as _i18;
import 'package:tv_maze_app/domain/usecases/get_episodes_by_series.dart'
    as _i16;
import 'package:tv_maze_app/domain/usecases/get_series_details.dart' as _i17;
import 'package:tv_maze_app/domain/usecases/search_series.dart' as _i19;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i8.Box<dynamic>>(() => registerModule.box);
    gh.lazySingleton<_i9.Dio>(() => registerModule.dio);
    gh.lazySingleton<_i10.TvMazeApiService>(
        () => registerModule.tvMazeApiService);
    gh.lazySingleton<_i11.NetworkInfo>(() => registerModule.networkInfo);
    gh.lazySingleton<_i12.SeriesLocalDataSource>(
        () => registerModule.localDataSource);
    gh.lazySingleton<_i13.SeriesRepository>(
        () => registerModule.seriesRepository);
    gh.lazySingleton<_i14.SeriesRemoteDataSource>(
        () => registerModule.seriesRemoteDataSource);
    gh.lazySingleton<_i15.GetAllSeries>(
        () => registerModule.getAllSeriesUseCase);
    gh.lazySingleton<_i16.GetEpisodesBySeries>(
        () => registerModule.getEpisodesBySeriesUseCase);
    gh.lazySingleton<_i17.GetSeriesDetails>(
        () => registerModule.getSeriesDetailsUseCase);
    gh.lazySingleton<_i18.GetEpisodeDetails>(
        () => registerModule.getEpisodeDetailsUseCase);
    gh.lazySingleton<_i19.SearchSeries>(
